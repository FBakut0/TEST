...
if(str==null){                                         //用户id为空,没有登录
	...
	{
		out.print("<li><a style='display:inline;float:right;text-decoration:none;color:red' href='clear.jsp'>[退出]</a>");
...
<div class="top">
    <div class="w t_cen">
        <div class="t_c_logo"><a href="index.jsp"><img src="images/logo.png" /></a></div>
